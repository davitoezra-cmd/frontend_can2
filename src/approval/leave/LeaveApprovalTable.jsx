...
const LeaveApprovalTable = ({ data, onDetail }) => {
        ...
        <table className="table table-hover align-middle mb-0">
          <thead className="table-light">
            <tr>
              ...
              <th className="py-3 px-4">Tanggal Cuti</th>
            ...
            {data.length === 0 ? (
              ...
              data.map((item, index) => (
                <tr key={item.id || index}>
                  ...
                  <td className="px-4">{item.start_date ? `${item.start_date} s/d ${item.end_date}` : '-'}</td>
                  <td className="px-4">{item.type || 'Cuti'}</td>
                  <td className="px-4">
